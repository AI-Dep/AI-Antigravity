...
def classify_transaction_type(
    ...
    disposal_indicators = ["dispos", "retire", "scrap", "writeoff", "write-off"]
    # More specific phrases that won't match common business terms
    disposal_phrases = ["sold to", "sale of", " sold ", "asset sold", "was sold"]
    ...
    # Check description for disposal indicators (these are specific enough)
    ...
    # Check for disposal phrases (more specific, avoid "Sales Rep" false positive)
    ...
    transfer_indicators = ["transfer", "xfer", "reclass", "reclassify"]
    ...
    # Check description - only use specific transfer terms
